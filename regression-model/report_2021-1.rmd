...
for (i in 1:length(climate$MINST))
{
  if (i == 12 || i == 25 || i == 10 || i == 4 | i == 22) 
    text(climate$MINST[i]-0.3, climate.lm$resid[i], as.character(i))    
  else
    text(climate$MINST[i]+0.3, climate.lm$resid[i], as.character(i))  
...
for (i in 1:length(climate$MAXAT))
{
  if (i == 12 || i == 13 || i == 23 || i == 4 ) 
    text(climate$MAXAT[i]-0.4, climate.lm$resid[i], as.character(i))  
  else
...
for (i in 1:length(climate$AVAT))
{
  ...
  text(climate$AVAT[i]+0.3, climate.lm$resid[i], as.character(i))  
}
```
